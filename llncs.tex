...
%
\begin{document}
\markboth{Barriers to the implementation of k-anonymity and related microdata anonymization techniques in a realworld application}{Barriers to the implementation of k-anonymity and related microdata anonymization techniques in a realworld application}
\thispagestyle{empty}
\rule{\textwidth}{1pt}
\vspace{2pt}
\begin{flushright}
